...
struct InstructionResult op_ld_a_hl_addr(struct State* state);
struct InstructionResult op_ld_b_a(struct State* state);
...
struct InstructionResult op_ld_b_hl_addr(struct State* state);
...
struct InstructionResult op_ld_c_hl_addr(struct State* state);
...
struct InstructionResult op_ld_d_hl_addr(struct State* state);
...
struct InstructionResult op_ld_e_hl_addr(struct State* state);
...
struct InstructionResult op_ld_h_hl_addr(struct State* state);
...
struct InstructionResult op_ld_bc_u16(struct State* state);
...
struct InstructionResult op_push_af(struct State* state);
struct InstructionResult op_push_bc(struct State* state);
struct InstructionResult op_push_de(struct State* state);
struct InstructionResult op_push_hl(struct State* state);

struct InstructionResult op_pop_af(struct State* state);
struct InstructionResult op_pop_bc(struct State* state);
struct InstructionResult op_pop_de(struct State* state);
struct InstructionResult op_pop_hl(struct State* state);
